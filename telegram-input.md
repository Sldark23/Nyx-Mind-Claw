...
> Nota: Esta spec é do canal **Telegram** do projeto **NyxMindClaw**. O framework global é multi-plataforma.
...
- Como acionar o Whisper local a partir do backend Node.js (se NyxMindClaw ainda for Node). *Decisão pendente: usar bridge FFI, ou Child Process nativo na máquina.*
