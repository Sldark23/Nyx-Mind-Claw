# Spec: PRD — NyxMindClaw Core

> Nota: PRD adaptado para **NyxMindClaw** multi-plataforma (Discord/Telegram/WhatsApp/CLI/API).

**Versão:** 1.0
**Status:** Aprovada
**Autor:** NyxMindClaw Agent
**Data:** 2026-03-06
**Reviewers:** Sandeco
...
O NyxMindClaw é um agente pessoal de Inteligência Artificial para operar 100% localmente no desktop do usuário. Ele recebe comandos exclusivamente pelo Telegram, processa-os através de um pipeline que suporta múltiplos LLMs dinamicamente, e tem acesso persistente à memória em SQLite.
...
O usuário envia um chat no Telegram, o NyxMindClaw roda local em background num terminal, chama LLMs, lê Skills em pastas locais, aciona ferramentas e responde no mesmo chat de forma orgânica.
